...
var fallbackSrc = function (imageService) {
    var directive = {
        restrict: "A",
...
fallbackSrc.$inject = ["imageService"];

var loadingSrc = function ($interpolate, imageService) {
...
loadingSrc.$inject = ["$interpolate", "imageService"];
